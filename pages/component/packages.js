  ...
  return (
    <div>
      <div className="design relative">
        {" "}
        <img src="./images/design-1.png" alt="logo" />
      </div>
      <Contanier>
        <Package1 className="">
          <div className="mt-[-700px]">
            <div
              className="heading text-center font-medium"
              style={{ color: "#4628ba" }}
              data-aos="fade-down"
            >
              OUR PACKAGES
            ...
            <div
              className="heading text-center md:text-[40px] text-[30px] font-medium"
              data-aos="fade-down"
            >
          ...
          <div className="flex flex-wrap justify-center gap-10 mt-10 relative z-1">
            {Items.map((i) => {
              return (
                <div key={i.plan} className="card border" data-aos="flip-right">
                  <div className="text-[20px]">{i.plan}</div>
                  <div className="md:text-[35px] text-[30px] font-semibold">
                    {" "}
                    {i.price}
                  </div>
                  <hr />
                  ...
                  <div>
                    {" "}
                    <button className="border rounded-full font-semibold">
                      Choose plan
                    </button>{" "}
                  </div>
                </div>
